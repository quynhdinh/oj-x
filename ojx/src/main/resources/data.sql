...
insert into problem (problem_id, problem_name, problem_statement, difficulty, tags) values
(1, 'Two Sum', 'Given an array of integers nums and an integer target, return indices of the two numbers such that they add up to target. You may assume that each input would have exactly one solution, and you may not use the same element twice.', 'Easy', 'Array,Hash Table'),
(2, 'Add Two Numbers', 'You are given two non-empty linked lists representing two non-negative integers. The digits are stored in reverse order, and each of their nodes contains a single digit. Add the two numbers and return the sum as a linked list.', 'Medium', 'Linked List,Math,Recursion'),
(3, 'Longest Substring Without Repeating Characters', 'Given a string s, find the length of the longest substring without repeating characters.', 'Medium', 'Hash Table,String,Sliding Window'),
(4, 'Median of Two Sorted Arrays', 'Given two sorted arrays nums1 and nums2 of size m and n respectively, return the median of the two sorted arrays.', 'Hard', 'Array,Binary Search,Divide and Conquer'),
...
insert into test_case (test_case_id, problem_id, input, output, is_sample) values
